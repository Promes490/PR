...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            ...
            $stmt = $pdo->prepare("SELECT id, username, fullname, password, role FROM users WHERE username = ? OR email = ?");
                ...
                <div class="col-lg-6">
                    <div class="login_box_img">
                        ...
                        <div class="hover">
                            ...
                            <p>Join thousands of satisfied customers and start shopping with us today!</p>
