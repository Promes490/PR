...
$checkAdmin = $pdo->query("SELECT COUNT(*) FROM users WHERE is_admin = 1")->fetchColumn();
$isAdmin = $checkAdmin == 0 ? 1 : 0;

// Insert new user
$stmt = $pdo->prepare("INSERT INTO users (fullname, email, username, password, is_admin) VALUES (?, ?, ?, ?, ?)");
$stmt->execute([$fullname, $email, $username, $hashedPassword, $isAdmin]);
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="login_box_img">
                        ...
                        <div class="hover">
                            ...
                            <p>Welcome back! Sign in to access your account and continue your shopping experience.</p>
                ...
                <div class="col-lg-6">
                    <div class="login_form_inner">
                        ...
                        <form class="row login_form" action="signup.php" method="post" id="signupForm">
							...
							<div class="col-md-12 form-group">
								<div class="creat_account">
									<input type="checkbox" id="f-option3" name="terms" required>
									<label for="f-option3">I agree to the Terms & Conditions</label>
								</div>
							</div>
							<div class="col-md-12 form-group">
